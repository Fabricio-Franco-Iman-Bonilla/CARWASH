...
<form action="dashProd.jsp?pagina=producto_listar" method="post">
    Codigo <br>
    <input type="text" class="form-control" name="codigo" style="width: 30%" readonly value="<%=p.getId()%>"> <br>
    Nombre <br>
    ...
    Cantidad <br>
    <input type="text" class="form-control" name="cantidad" style="width: 30%" readonly value="<%=p.getStock()%>"> <br><br> 
